...
export const th: typeof en = {
  ...
  stack: {
    ...
    categories: {
      ...
      backend: "แบ็กเอนด์ & ข้อมูล",
      tools: "เครื่องมือ & ดีพลอย",
    },
  },
  selectedWork: {
    eyebrow: "ผลงานเด่น",
  ...
  process: {
    ...
    subtitle: "ไม่มีกล่องดำ คุณเห็นของที่ใช้งานได้ตั้งแต่เนิ่น ๆ และเห็นบ่อย",
    steps: [
      {
        title: "คุยให้ชัด",
  ...
  principles: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "คนที่คุยกับคุณคือคนที่สร้างงาน ไม่มีส่งต่อ ไม่มีเด็กฝึกงานมาลองของด้วยงบของคุณ",
      },
      {
        title: "เทคโนโลยีน่าเบื่อ ผลลัพธ์น่าตื่นเต้น",
        desc: "Next.js, NestJS และ TypeORM — ของที่พิสูจน์แล้ว เว็บของคุณเลยเร็ว ปลอดภัย ดูแลง่าย",
      },
    ],
  },
  about: {
  ...
  notFound: {
    ...
    body: "หน้าที่คุณมองหาไม่มีอยู่จริง",
    home: "กลับหน้าหลัก",
  },
}
